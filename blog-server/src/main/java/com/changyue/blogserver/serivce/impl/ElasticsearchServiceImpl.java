...
public class ElasticsearchServiceImpl implements ElasticsearchService {
    ...
    @Override
    public Result indexArticle(Post post, ElasticsearchStatus elasticsearchStatus) {
        ...
        //索引
        Index index = new Index.Builder(article).index(BlogProperties.ES_INDEX).type(BlogProperties.ES_TYPE).build();
    ...
    @Override
    public Result searchArticle(HomeQuery homeQuery) {
    ...
    public Result removeArticle(@Nonnull String id) {
        Delete delete = new Delete.Builder(id).index(BlogProperties.ES_INDEX).type(BlogProperties.ES_TYPE).build();
        DocumentResult result;
        try {
