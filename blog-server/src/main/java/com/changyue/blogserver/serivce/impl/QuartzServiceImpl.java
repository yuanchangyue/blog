...
public class QuartzServiceImpl implements QuartzService {
    ...
    public void startScheduler() {
        try {
            ...
            log.info("scheduler启动失败：" + e.getMessage());
        }
    }
    ...
    public void addJob(Class<? extends QuartzJobBean> jobClass, String jobName, String jobGroupName, String jobTime, Map jobData) {
        log.info("正在添加定时任务：jobName：[{}],jobName:[{}]", jobClass, jobName);
        try {
        ...
        log.info("完成定时任务的添加：jobName：[{}],jobName:[{}]", jobClass, jobName);
    }
